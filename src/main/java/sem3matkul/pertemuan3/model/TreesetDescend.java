...
public class TreesetDescend {
    private final TreeSet<String> treeset = new TreeSet<>(Collections.reverseOrder());
    ...
    public NavigableSet<String> getAscending() {
    ...
    public TreeSet<String> getTreeSetDesc() {
        return treeset;
    }
}